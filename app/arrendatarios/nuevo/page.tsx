...
export default function NuevoArrendatario() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = await supabase.from('arrendatarios').insert(datos)
  ...
  return (
    <div className="p-8 max-w-xl">
      <h1 className="text-3xl font-bold mb-6">Nuevo Arrendatario</h1>
        ...
        {tipo === 'sociedad' ? (
          <>
            ...
            <div>
              ...
              <input name="rut" value={form.rut} onChange={handleChange} placeholder="12.345.678-9" className="w-full border p-2 rounded" required />
            </div>
            <hr />
          ...
          <>
            ...
            <div>
              ...
              <input name="apellido" value={form.apellido} onChange={handleChange} className="w-full border p-2 rounded" required />
            </div>
            <div>
